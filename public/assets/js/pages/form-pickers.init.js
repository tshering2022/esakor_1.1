...
if (classicPickrDemo) classicPickrDemo.forEach(function () {
  Pickr.create({
...
if (monolithColorPickr) monolithColorPickr.forEach(function () {
  Pickr.create({
...
if (nanoColorPickr) nanoColorPickr.forEach(function () {
  Pickr.create({
    el: ".nano-colorpicker",
    theme: "nano",
    "default": "#3577f1",
...
if (demoColorPickr) demoColorPickr.forEach(function () {
  Pickr.create({
    el: ".colorpicker-demo",
    theme: "monolith",
    "default": "#405189",
...
if (opacityHueColorPickr) opacityHueColorPickr.forEach(function () {
  Pickr.create({
...
if (swatcherColorPickr) swatcherColorPickr.forEach(function () {
  Pickr.create({
...
if (inputColorPickr) inputColorPickr.forEach(function () {
  Pickr.create({
...
if (formatColorPickr) formatColorPickr.forEach(function () {
  Pickr.create({
