        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Transaction View</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <div id="customerList">
                            ...
                            <table class="table align-middle table-nowrap" id="customerTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="email">Transaction No</th>
                                        <th class="sort" data-sort="phone">Date</th>
                                        <th class="sort" data-sort="date">Thromde/Dzongkhag</th>
                                        <th class="sort" data-sort="date">Thromde Village</th>
                                        <th class="sort" data-sort="date">Status</th>
                                        <th class="sort" data-sort="status">Author</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <div class="edit">
                                                    <div class="btn btn-sm btn-success edit-item-btn"
                                                        data-bs-toggle="modal" data-bs-target="#showModal"><i data-feather="edit-3">Edit</i></div>
                                                </div>
                                                <div class="remove">
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esakor_1.1\resources\views/front-end/transaction-table.blade.php ENDPATH**/ ?>