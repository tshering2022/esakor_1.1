                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                <form action="<?php echo e(route('login')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-3">
                                        <label for="username" class="form-label">Username » <small>Email ID or Mobile Number.</small> </label>
...
<?php echo $__env->make('menu.auth_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/NLCS-project/Laravel/default/resources/views/auth/login.blade.php ENDPATH**/ ?>