...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <img src="<?php echo e(URL::asset('assets/img/banner/wellcom.webp')); ?>" class="flex-shrink-0 me-5 rounded"height="190"width="420"alt="..." />
            </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/NLCS-project/Laravel/default/resources/views/backend/index.blade.php ENDPATH**/ ?>