                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img class="rounded" alt="200x200" width="200" src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                                <div class="mt-4 mt-md-0">
                                    <img class="rounded-circle avatar-xl" alt="200x200" src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" data-holder-rendered="true">
                                </div>
                            </div><!-- end col -->
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <img class="img-thumbnail" alt="200x200" width="200" src="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>" data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                                <div class="mt-4 mt-md-0">
                                    <img class="img-thumbnail rounded-circle avatar-xl" alt="200x200" src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" data-holder-rendered="true">
                                </div>
                            </div><!-- end col -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" alt="" class="rounded avatar-xxs">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xxs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-10.jpg')); ?>" alt="" class="rounded avatar-xs">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" alt="" class="rounded avatar-sm">
                                            <p class="mt-2 mb-lg-0"><code>avatar-sm</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" alt="" class="rounded avatar-md">
                                            <p class="mt-2  mb-lg-0"><code>avatar-md</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-5.jpg')); ?>" alt="" class="rounded avatar-lg">
                                            <p class="mt-2 mb-lg-0"><code>avatar-lg</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" alt="" class="rounded avatar-xl">
                            ...
                            <div class="col-md-12">
                                <div class="row g-3 mt-5">
                                    ...
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" alt="" class="rounded-circle avatar-md">
                                            <p class="mt-2  mb-lg-0"><code>avatar-md</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-5.jpg')); ?>" alt="" class="rounded-circle avatar-lg">
                                            <p class="mt-2 mb-lg-0"><code>avatar-lg</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" alt="" class="rounded-circle avatar-xl">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xl</code></p>
                                        </div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" class="figure-img img-fluid rounded" alt="...">
                                    <figcaption class="figure-caption">A caption for the above image.</figcaption>
                                </figure>
                            </div>
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-5.jpg')); ?>" class="figure-img img-fluid rounded" alt="...">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div>
                            <img src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" class="img-fluid" alt="Responsive image">
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/NLCS-project/Laravel/default/resources/views/ui-images.blade.php ENDPATH**/ ?>