<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.media-object'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?> Components <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> Media Object <?php $__env->endSlot(); ?>
                    ...
                    <div class="live-preview">
                        <div class="d-flex align-items-start text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-sm rounded" alt="...">
                            </div>
                        ...
                        <div class="d-flex align-items-start text-muted mb-4">
                            ...
                            <div class="flex-shrink-0 ms-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" class="avatar-sm rounded" alt="...">
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="d-flex align-items-start text-muted">
                            <div class="flex-shrink-0 me-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" class="avatar-sm rounded" alt="...">
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="fs-14">Media heading</h5>
                                This is some content from a media component. You can replace this with any content and adjust it as needed.
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="d-flex align-items-center text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" class="avatar-sm rounded" alt="...">
                            </div>
                        ...
                        <div class="d-flex align-items-end text-muted">
                            <div class="flex-shrink-0 me-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" class="avatar-sm rounded" alt="...">
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/NLCS-project/Laravel/default/resources/views/ui-media.blade.php ENDPATH**/ ?>