            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="<?php echo e(url('/')); ?>" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo e(URL::asset('assets/img/logo/Logo-2.png')); ?>" alt="" height="65">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('assets/img/logo/Logo-2.png')); ?>" alt="" height="65">
                        </span>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle light-dark-mode">
                        <i class='las la-question-circle fs-22'></i>
                    </button>
                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/NLCS-project/Laravel/default/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>