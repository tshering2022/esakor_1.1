                            ...
                            <div class="card-body p-4">
                                <div class="row align-items-center team-row">
                                    ...
                                    <div class="col-lg-4 col">
                                        <div class="team-profile-img">
                                            <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                            </div>
                                            <div class="team-content">
                            ...
                            <div class="card-body p-4">
                                <div class="row align-items-center team-row">
                                    ...
                                    <div class="col-lg-4 col">
                                        <div class="team-profile-img">
                                            <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/users/avatar-8.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                            </div>
                                            <div class="team-content">
                            ...
                            <div class="card-body p-4">
                                <div class="row align-items-center team-row">
                                    ...
                                    <div class="col-lg-4 col">
                                        <div class="team-profile-img">
                                            <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                            </div>
                                            <div class="team-content">
                            ...
                            <div class="card-body p-4">
                                <div class="row align-items-center team-row">
                                    ...
                                    <div class="col-lg-4 col">
                                        <div class="team-profile-img">
                                            <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                            </div>
                                            <div class="team-content">
                            ...
                            <div class="card-body p-4">
                                <div class="row align-items-center team-row">
                                    ...
                                    <div class="col-lg-4 col">
                                        <div class="team-profile-img">
                                            <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                            </div>
                                            <div class="team-content">
                            ...
                            <div class="card-body p-4">
                                <div class="row align-items-center team-row">
                                    ...
                                    <div class="col-lg-4 col">
                                        <div class="team-profile-img">
                                            <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/users/avatar-7.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                            </div>
                                            <div class="team-content">
